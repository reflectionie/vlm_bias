...
# image description 
# PYTHONPATH=/net/papilio/storage7/tingyuan/llama/bias/vlm_bias python open_ended/image_tasks/image_description/Phi-3.5-vision-instruct/description_generation_no_vllm.py --custom_suffix original
