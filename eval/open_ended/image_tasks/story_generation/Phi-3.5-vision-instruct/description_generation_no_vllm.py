...
if __name__ == "__main__":
    ...
    parser.add_argument("--question", type=str, default="Write an imaginative story inspired by this image. Include a beginning, middle, and an ending.", help="Question to ask the model.")
