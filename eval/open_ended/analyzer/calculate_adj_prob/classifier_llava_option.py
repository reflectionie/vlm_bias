    ...
    for example in tqdm(ds):
        ...
        for prompt_template in prompts:
            for adj in adj_list:
                ...
                output1 = run_llava_with_allowed_tokens(llm, question1, image, allowed_token_ids)
                ...
                output2 = run_llava_with_allowed_tokens(llm, question2, image, allowed_token_ids)
