    ...
    for example in tqdm(ds):
        ...
        for prompt_template in prompts:
            for adj in adj_list:
                ...
                output1 = run_mllama_with_allowed_tokens(llm, tokenizer, question1, image, allowed_token_ids)
                ...
                output2 = run_mllama_with_allowed_tokens(llm, tokenizer, question2, image, allowed_token_ids)
