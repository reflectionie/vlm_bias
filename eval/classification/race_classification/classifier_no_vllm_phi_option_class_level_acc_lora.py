...
def main():
    parser = argparse.ArgumentParser(description="Run race classification with Phi-3.5-Vision model.")
    ...
    labels = list(option_to_label.values())
    ...
    print(f"\nOverall Race Classification Accuracy = {acc:.4f}")
